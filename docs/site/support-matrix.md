...
| `openai` | `experimental` | models, chat completions, responses | chat success, stream success, rate limit, context length, auth error | Deterministic fake responses; no real model inference. |
...
2. Sanitized fixtures and spec snapshot policy.
3. SDK contract harness foundation.
4. Stateful provider workflows.
