...
Phase 0-22, 31 は完了済みの歴史記録です。現在の計画は [ROADMAP.md](../ROADMAP.md) が正です。
...
tasks/
  ...
  phase22_2_go_10_of_10_hardening.md
...
Phase 22.2 は「Go の言語特性と標準 tooling を 10/10 レベルまで活かすために、typed response、context/error/runtime、state clone、static analysis、readiness evidence を固める」までです。
...
- `docs/archive/design/docs/02_mvp_scope.md`
- `docs/archive/design/docs/03_architecture.md`
- `docs/archive/design/docs/04_go_engineering_guide.md`
- `docs/archive/design/docs/06_config_spec.md`
- `docs/archive/design/docs/07_adapter_design.md`
- `docs/archive/design/docs/08_cli_spec.md`
- `docs/archive/design/docs/09_docker_runtime.md`
- `docs/archive/design/docs/10_ai_safe_security.md`
- `docs/archive/design/docs/11_testing_strategy.md`
- `docs/archive/design/docs/12_roadmap.md`
