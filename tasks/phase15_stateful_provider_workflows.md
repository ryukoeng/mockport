...
**Tech Stack:** Go 1.26.3, in-memory stores, deterministic IDs, httptest, SDK contract runner foundation.
...
- [ ] Run adapter tests and the SDK contract runner foundation.
...
- [ ] Adapter tests and the SDK contract runner foundation can exercise stateful behavior.
