# Phase 25 SDK Contract All Provider Harness 日本語版

[English](phase25_sdk_contract_all_provider_harness.md)

全 provider adapter に SDK/client contract harness を広げる phase です。
